...
- Keyboard, focus, aria-live, reduced motion - PASS. F/C/A/R/I worked for enabled actions, shortcuts were ignored in the raise input, live regions and alert roles were present, and reduced-motion CSS was active.
